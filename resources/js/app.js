...
import ContactCategoryRoutes from "../../Modules/Contact/Assets/js/categories/CategoryRoutes";
import ProductRoutes from "../../Modules/Product/Assets/js/products/ProductRoutes";
import ProductCategoryRoutes from "../../Modules/Product/Assets/js/categories/CategoryRoutes";
import ProjectRoutes from "../../Modules/Project/Assets/js/projects/ProjectRoutes";
import ProjectCategoryRoutes from "../../Modules/Project/Assets/js/categories/CategoryRoutes";
...
const router = new VueRouter({
  ...
  base: makeBaseUrl(),
  routes: [
    ...MediaRoutes, ...UserRoutes, ...ContactRoutes, ...ContactCategoryRoutes, ...ProductRoutes, ...ProductCategoryRoutes, ...ProjectRoutes, ...ProjectCategoryRoutes,
  ],
}),
  messages = {
