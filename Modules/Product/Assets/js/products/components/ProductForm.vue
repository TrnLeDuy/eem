                            ...
                            <el-tabs v-model="activeTab">
                                <el-tab-pane v-for="(localeArray, locale) in locales" :key="localeArray.name"
                                    ...
                                    <el-form-item :label="trans('products.form.title')" :class="{
                                        ...
                                        <el-input v-model="product[locale].title"
                                    ...
                                    <el-form-item :label="trans('products.form.description')" :class="{
                                        'el-form-item is-error': form.errors.has(
                                            locale + '.description'
                                        ),
                                    }">
                                        <component :is="getCurrentEditor()" v-model="product[locale].description"
                                            :value="product[locale].description"></component>
                                    ...
                                    <el-form-item :label="trans('products.form.product_info')" :class="{
                                        ...
                                        <div v-if="form.errors.has(locale + '.product_info')"
                                        ...
                                        <div :id="`collapseMeta-${locale}`" style="height: 0"
                                            ...
                                            <div class="box-body">
                                                ...
                                                <el-form-item :label="trans('core.form.meta_description')">
                                                    <el-input v-model="product[locale].meta_description" type="textarea"
                    ...
                    <div class="box box-primary">
                        <div class="box-body">
                            <el-form-item :label="trans('products.form.code')" :class="{
                                ...
                                <div v-if="form.errors.has('code')" class="el-form-item__error"
                            ...
                            <el-form-item :label="trans('products.form.rating')" :class="{
                                'el-form-item is-error': form.errors.has('rating'),
                            }">
                                <el-input v-model="product.rating"></el-input>
                                <div v-if="form.errors.has('rating')" class="el-form-item__error"
                                    v-text="form.errors.first('rating')"></div>
                            </el-form-item>
                            <el-form-item :label="trans('products.form.product_status')" :class="{
                                'el-form-item is-error': form.errors.has('product_status'),
                            }">
                                <el-select v-model="product.product_status" placeholder="Chọn trạng thái">
                                    <el-option :value="1" label="Hiển thị giá"></el-option>
                                    <el-option :value="2" label="Liên hệ"></el-option>
                                    <el-option :value="3" label="Hiển thị giá và Liên hệ"></el-option>
                                </el-select>
                            ...
                            <el-form-item :label="trans('products.form.show_homepage')" :class="{
                                ...
                                <el-switch v-model="product.show_homepage" active-color="#13ce66"
                            ...
                            <el-form-item :label="trans('products.form.is_promotion')" :class="{
                                ...
                                <el-switch v-model="product.is_promotion" active-color="#13ce66"
                                    inactive-color="#ff4949">
                                </el-switch>
                                <div v-if="form.errors.has('is_promotion')" class="el-form-item__error"
                                    v-text="form.errors.first('is_promotion')"></div>
                            </el-form-item>
                            <single-media :entity-id="product.id" zone="avatar"
                                entity="Modules\Product\Entities\Product"
                                @single-file-selected="selectSingleFile($event, 'product')"></single-media>
                            <br />
                            <multiple-media zone="slider_product"
                                @multiple-file-selected="selectMultipleFile($event, 'product')"
                                @file-unselected="unselectFile($event, 'product')"
                                entity="Modules\Product\Entities\Product" :entity-id="product.id"></multiple-media>
                        </div>
                    </div>
                </div>
            </div>
