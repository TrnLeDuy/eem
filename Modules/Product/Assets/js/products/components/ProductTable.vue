<template>
    <div class="div">
                    ...
                    <div class="box-body">
                        <div class="sc-table">
                            ...
                            <el-table ref="pageTable" v-loading.body="tableIsLoading" :data="data" stripe
                                ...
                                <el-table-column :label="trans('products.table.avatar')" width="100">
                                    <template slot-scope="scope">
                                        <img :src="scope.row.avatar" width="70px" />
                                    </template>
                                </el-table-column>
                                <el-table-column :label="trans('products.table.title')" prop="translations.title">
                                    <template slot-scope="scope">
                                ...
                                <el-table-column :label="trans('products.table.price')">
                                    <template slot-scope="scope">
                                        {{ scope.row.price }}
                                    </template>
                                </el-table-column>
                                <el-table-column :label="trans('products.table.price_sale')">
                                    <template slot-scope="scope">
        ...
        <button v-show="false" v-shortkey="['c']"
            @shortkey="pushRoute({ name: 'admin.product.product.create' })"></button>
    </div>
</template>
