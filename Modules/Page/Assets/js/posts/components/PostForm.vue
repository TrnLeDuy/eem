            ...
            <div class="box-body">
              <el-tabs v-model="activeTab">
                ...
                >
                  ...
                  <el-form-item
                    :label="trans('pages.author')"
                    :class="{ 'el-form-item is-error': form.errors.has(locale + '.author') }"
                  >
                    <el-input v-model="post[locale].author"></el-input>
                    <div
                      v-if="form.errors.has(locale + '.author')"
                      class="el-form-item__error"
                      v-text="form.errors.first(locale + '.author')"
                    ></div>
                  </el-form-item>
