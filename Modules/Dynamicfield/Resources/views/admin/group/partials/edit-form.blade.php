	...
	<div class="col-md-12 group-content">
		<div class="box box-body">
			...
			<div class="postbox" id="location">
				<h3 class="title"><span>{{ trans('dynamicfield::group.location.title') }}</span></h3>
				<div class="inside">
					<table class="data-table table dataTable table-location">
						<tbody>
							<tr>
								<td class="rule-des">
									<label for="post_type">{{ trans('dynamicfield::group.location.rules_label') }}</label>
									<p class="description">{{ trans('dynamicfield::group.location.rules_description') }}</p>
								</td>
								<td>
