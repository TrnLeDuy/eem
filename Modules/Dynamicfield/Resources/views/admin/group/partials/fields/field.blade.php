		...
		<tr>
			...
			<td class="field-label col-md-3">
				...
				<div class="row-options">
					<a class="btn-toggle" href="javascript:;">{{ trans('core::core.button.edit') }}</a>
					|
					<?php $fieldId = $field->id; ?>
					<a class="btn-delete-field" href="javascript:;" data-id={{ $fieldId }} delete-list-id="fields-deleted" >{{ trans('core::core.button.delete') }}</a>
				</div>
			</td>
