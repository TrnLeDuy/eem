<template>
    <div class="div">
                        ...
                        <div class="sc-table">
                            <div class="tool-bar el-row" style="padding-bottom: 20px">
                                <div class="actions el-col el-col-8">
                                    <router-link :to="{ name: 'admin.project.project.create' }">
                                        <el-button type="primary">
                                            <i class="el-icon-edit"></i>
                                            {{ trans("projects.title.create project") }}
                                        </el-button>
                                    </router-link>
                                </div>
                            ...
                            <el-table ref="pageTable" v-loading.body="tableIsLoading" :data="data" stripe
                                ...
                                <el-table-column :label="trans('projects.table.title')" prop="translations.title">
                                    <template slot-scope="scope">
                                ...
                                <el-table-column :label="trans('projects.table.slug')" prop="translations.slug">
                                    <template slot-scope="scope">
                                        <a :href="editRoute(scope)" @click.prevent="goToEdit(scope)">
                                ...
                                <el-table-column :label="trans('core.table.actions')" width="130" prop="actions">
                                    <template slot-scope="scope">
                                        <el-button-group>
                                            <edit-button :to="{
        ...
        <button v-show="false" v-shortkey="['c']"
            @shortkey="pushRoute({ name: 'admin.project.project.create' })"></button>
    </div>
</template>
    ...
    export default {
        ...
        methods: {
            queryServer(customProperties) {
                ...
                axios
                    .get(
                        route("api.project.project.indexServerSide", {
                            ...properties,
                            ...customProperties,
                        })
                    )
