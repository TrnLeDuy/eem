...
use Modules\Project\Transformers\Backend\CategoryTransformer;
use Modules\Project\Transformers\Backend\SmallCategoryTransformer;
use Modules\Project\Transformers\Backend\FullCategoryTransformer;
...
class CategoryApiController extends Controller
{
    ...
    public function store(CreateCategoryRequest $request)
    {
        ...
        return response()->json([
            'errors' => false,
            'message' => trans('project::categories.messages.categories created'),
            'data' => $data
        ]);
    }
    ...
    public function update($categoryId, UpdateCategoryRequest $request)
    {
        ...
        return response()->json([
            'errors' => false,
            'message' => trans('project::categories.messages.categories updated'),
        ]);
    }
    ...
    public function destroy($categoryId)
    {
        ...
        return response()->json([
            'errors' => false,
            'message' => trans('project::categories.messages.categories deleted'),
        ]);
    }
}
