<template>
    <div class="div">
                        ...
                        <div class="sc-table">
                            <div class="tool-bar el-row" style="padding-bottom: 20px">
                                <div class="actions el-col el-col-8">
                                    <router-link :to="{ name: 'admin.contact.category.create' }">
        ...
        <button v-show="false" v-shortkey="['c']"
            @shortkey="pushRoute({ name: 'admin.contact.category.create' })"></button>
    </div>
</template>
    ...
    export default {
        ...
        methods: {
            queryServer(customProperties) {
                ...
                axios
                    .get(
                        route("api.contact.category.indexServerSide", {
                            ...properties,
                            ...customProperties,
                        })
                    )
